import { ExternalLink, Monitor, Loader2, AlertTriangle, Clock } from "lucide-react";
...
const DesktopTab = ({ data, loading }: DesktopTabProps) => {
  console.log("DesktopTab data:", data);
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900 mb-1">Desktop Performance</h1>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <div className="flex items-start justify-between mb-3">
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 mb-3">
                  Serve images that are appropriately-sized to save bandwidth and improve load time.{" "}
      ...
      <div className="bg-red-50 rounded-xl p-6">
        ...
        <div className="space-y-3">
          {Object.entries(audits)
            .filter(([key, audit]) => audit.score !== null && audit.score < 0.9 && audit.details)
            .slice(0, 5)
            .map(([key, audit]) => (
